...
function processarDados(dados) {
    ...
    const labels = ["nova york","área da baía de são franscico","tóquio","singapura","londres","los angeles","paris","sidney","hong kong","pequim"]
    ...
    const layout = {
        ...
        height: 700,
        title: {
            text: 'Cidades mais ricas do mundo',
            x: 0,
            font: {
    ...
    incluirTexto(`Tóquio, Nova York e Londres são algumas das cidades mais ricas do mundo, destacando-se por sua economia forte e rica cultura. Tóquio é um hub de tecnologia, Nova York é o coração financeiro global, e Londres atrai investimentos com sua diversidade. Cidades como Paris, Hong Kong e Cingapura também são influentes, oferecendo qualidade de vida e oportunidades que impactam a economia global.`)
}
